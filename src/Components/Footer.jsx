  ...
  return (
    <div className='pt-10 px-4 md:px-20 lg:px-32 w-full bg-gray-900 overflow-hidden' id='Footer'>
        ...
        <div className='w-full md:w-1/3 mb-8 md:mb-0'>
            <img src={assets.resize} alt="" className='w-10  ' /> 
            <p className='text-gray-400 mt-4'>Lorem ipsum dolor sit amet consectetur adipisicing elit. 
                Repudiandae et fuga quae aperiam tempore quam similique, 
                sit dolores, harum quisquam explicabo quas eum beatae temporibus!</p>
        </div>
        ...
        <div className='border-t border-gray-700 py-4 mt-10 text-center text-gray-500'>
         Copyright 2024 © Dilip. All Right Reserved.
        </div>
    </div>
  )
}
