...
const Projects = () => {
  ...
  return (
    ...
    className=' container mx-auto py-4 pt-20 px-6 md:px-20 lg:px-32 my-20 w-full overflow-hidden' id='Projects'>
        ...
        <p className=' text-center text-gray-500 mb-8 max-w-80 mx-auto '>Creating Environments, Constructing Heritage - Discover Our Collection</p>

        {/*------Slider--Button-----*/}
        <div className='flex justify-end items-center mb-8'>
            <button onClick={prevProject} className='p-3 bg-gray-300 rounded mr-2' aria-level='Previous Projects'>
                <img src={assets.left_arrow} alt="Previous" />
            </button>

            <button onClick={nextProject} className='p-3 bg-gray-300 rounded mr-2' aria-level='Next Projects'>
