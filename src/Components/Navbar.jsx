  ...
  return (
    <div className='absolute top-0 left-0 w-full z-10'>
      <div className='container mx-auto flex justify-between
        ...
        <img src={assets.resize} alt="" className='w-12' />
        <ul className='hidden md:flex gap-7 text-white text-1xl md:text-1xl lg:text-2xl' >
      ...
      <div className={`md:hidden ${showMobileMenu ? 'fixed w-full' : 'h-0 w-0'} fixed w-full right-0 top-0 bottom-0 overflow-hidden bg-white transition-all`}>
        <div className='flex justify-end p-6 cursor-pointer'>
          ...
          }} src={assets.cross_icon} alt="" className='w-6' />
